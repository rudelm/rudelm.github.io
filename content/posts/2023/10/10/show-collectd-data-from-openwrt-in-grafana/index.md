...
[Telegraf](https://www.influxdata.com/time-series-platform/telegraf/) is a nice tool provided by InfluxDB to gather various data and transform it in an InfluxDB compatible format. I've [already used]({{< ref "/posts/2022/04/25/mosquitto-mqtt-to-influxdb-using-telegraf" >}}) it for gathering data from my Tasmota enabled switches using MQTT.
