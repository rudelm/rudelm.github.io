...
Blog posts are put into the `content/post` folder. The filenames are `index.md`. I recommend putting these to `content/posts/YYYY/MM/DD/post-title`, because it will enable cool stuff like image processing.
